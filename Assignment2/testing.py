...
Q= Q.T
# print(Q)
# Q = [[ 0.36256148, -0.71025936, -0.5363965 ,  0.27633243],
...
eigenvalues = np.array([[4.216163 , 4.216163], [0.21019471,0.21019471]])
print(eigenvalues.shape)
...
scaled_eigenvectors = np.dot( normalized_eigenvectors , eigenvalues)
scaled_eigenvectors = np.array(scaled_eigenvectors)

D = np.matmul (scaled_eigenvectors.T, scaled_eigenvectors) /4
print(D)
e = np.linalg.eig(D) # already returns eignvalues (in sorted order) and eigenvectors
Q11 = np.array([e[1][:, 0], e[1][:, 1]])
print(Q11)
Q11= Q11.T
...
# print(X1.shape)
# print(Q.shape)
# X2 = np.matmul(scaled_eigenvectors, Q11)
...
plt.quiver(0, 0, Q11[0, 0], Q11[1, 0], 
           angles='xy', scale_units='xy', scale=1, color='r', label='PC 1')
plt.quiver(0, 0, Q11[0, 1], Q11[1, 1], 
